...
import DrawerRead from './components/drawer-read';
import DrawerUpdate from './components/drawer-update';
import FilterOptions from './components/filter-option';
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center md:space-x-3 space-y-3 md:space-y-0 justify-between mx-4 py-4 border-t">
              ...
              <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                <button
                  ...
                  className="w-full md:w-auto flex items-center justify-center gap-x-1 py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200"
                >
                  <Icon
                    icon="si:add-fill"
                    width="18"
