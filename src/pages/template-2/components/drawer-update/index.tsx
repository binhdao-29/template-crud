export default function DrawerUpdate() {
  return (
    <form
      ...
      className="fixed top-0 left-0 z-40 w-full h-screen max-w-3xl p-4 overflow-y-auto transition-transform -translate-x-full bg-white"
    ...
    >
      ...
      <div className="grid gap-4 sm:grid-cols-3 sm:gap-6 ">
        <div className="space-y-4 sm:col-span-2 sm:space-y-6">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-3 gap-4 mb-4">
              <div className="relative p-2 bg-gray-100 rounded-lg sm:w-36 sm:h-36">
                <img
                  src="https://flowbite.s3.amazonaws.com/blocks/application-ui/products/imac-side-image.png"
                  alt="imac image"
                />
                <button type="button" className="absolute text-red-600 bottom-1 left-1">
                  <svg
                    aria-hidden="true"
                    className="w-5 h-5"
                    fill="currentColor"
          ...
          <div className="flex items-center mb-4">
            ...
            />
            <label htmlFor="product-options" className="ml-2 text-sm text-gray-500">
          ...
          <div className="relative">
            ...
            <input
              id="datepicker"
              type="text"
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 datepicker-input"
              value="15/08/2022"
        ...
        <div className="space-y-4 sm:space-y-6">
          <div>
            <label htmlFor="product-brand" className="block mb-2 text-sm font-medium text-gray-900">
              Brand
            </label>
            <input
              type="text"
      ...
      <div className="grid grid-cols-2 gap-4 mt-6 sm:w-1/2">
        ...
        <button
          type="button"
          className="text-red-600 inline-flex justify-center items-center hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
        >
          <svg
            aria-hidden="true"
