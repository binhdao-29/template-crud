export default function DrawerRead() {
  return (
    <div
      id="drawer-read-product-advanced"
      className="overflow-y-auto fixed top-0 left-0 z-40 p-4 w-full max-w-lg h-screen bg-white transition-transform -translate-x-full"
    ...
    >
      <div>
        ...
        <h5 className="mb-5 text-xl font-bold text-gray-900">$2999</h5>
      </div>
      <button
        type="button"
      ...
      <div className="grid grid-cols-3 gap-4 mb-4 sm:mb-5">
        <div className="p-2 w-auto bg-gray-100 rounded-lg">
          <img
      ...
      <dl className="grid grid-cols-2 gap-4 mb-4">
        <div className="col-span-2 p-3 bg-gray-100 rounded-lg border border-gray-200 sm:col-span-1">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Shipping</dt>
        ...
        <div className="col-span-2 p-3 bg-gray-100 rounded-lg border border-gray-200 sm:col-span-1">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Colors</dt>
          <dd className="flex items-center space-x-2 font-light text-gray-500">
        ...
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Product State</dt>
        ...
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Sold by</dt>
          <dd className="text-gray-500">Flowbite</dd>
        </div>
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Ships from</dt>
          <dd className="text-gray-500">Flowbite</dd>
        </div>
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Brand</dt>
          <dd className="text-gray-500">Apple</dd>
        </div>
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Dimensions (cm)</dt>
          <dd className="text-gray-500">105 x 15 x 23</dd>
        </div>
        <div className="p-3 bg-gray-100 rounded-lg border border-gray-200">
          <dt className="mb-2 font-semibold leading-none text-gray-900">Item weight</dt>
          <dd className="text-gray-500">12kg</dd>
        </div>
      </dl>
      <div className="flex bottom-0 left-0 justify-center pb-4 space-x-4 w-full">
        <button
          type="button"
          className="text-white w-full inline-flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
        >
          <svg
            aria-hidden="true"
        ...
        <button
          type="button"
          className="inline-flex w-full items-center text-white justify-center bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
        >
          <svg
            aria-hidden="true"
